...
<style>
	...
	.dash-title { font-size: 1.6rem; font-weight: 700; margin: 0 0 0.25rem; }
	.dash-subtitle { color: #6b7280; font-size: 0.9rem; margin: 0; }
	.dash-badge {
		background: #0ea5e9;
		color: #fff;
	...
	.card-body { flex: 1; display: flex; flex-direction: column; gap: 0.2rem; }
	.card-label { font-weight: 600; font-size: 0.95rem; }
	.card-count { font-size: 1.6rem; font-weight: 800; color: var(--accent, #0ea5e9); line-height: 1.1; }
	.count-skeleton {
	...
	.count-error { color: #9ca3af; }
	.card-desc { font-size: 0.8rem; color: #6b7280; }
	.card-arrow { font-size: 1.2rem; color: #9ca3af; flex-shrink: 0; }
	@keyframes pulse {
		0%, 100% { opacity: 1; }
		50% { opacity: 0.4; }
	}
