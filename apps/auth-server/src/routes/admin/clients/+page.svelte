...
<style>
	/* detail-list: wider label column variant of meta-row */
	...
	.copyable-row { display: flex; align-items: center; gap: 0.5rem; }
	.mono-value { font-family: monospace; font-size: 0.85rem; background: #f3f4f6; padding: 0.15rem 0.4rem; border-radius: 4px; word-break: break-all; }
	.btn-copy { flex-shrink: 0; display: inline-flex; align-items: center; justify-content: center; width: 1.75rem; height: 1.75rem; border: 1px solid #d1d5db; border-radius: 4px; background: #fff; cursor: pointer; font-size: 0.9rem; color: #4f46e5; }
	.btn-copy:hover { background: #eef2ff; border-color: #4f46e5; }
