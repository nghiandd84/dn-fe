...
export type Translation = {
	...
	events_page: {
		...
		col_venue_name: string;
		col_total_seats: string;
		col_status: string;
		col_sale_start_time: string;
...
export type TranslationFunctions = {
	...
	events_page: {
		...
		col_event_name: () => LocalizedString;
		col_event_date: () => LocalizedString;
		col_venue_name: () => LocalizedString;
		col_total_seats: () => LocalizedString;
		col_status: () => LocalizedString;
		col_sale_start_time: () => LocalizedString;
